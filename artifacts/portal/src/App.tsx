...
const OfficerOrders = lazy(() => import("./pages/officer/OfficerOrders"));
...
const OrderCatering = lazy(() => import("./pages/OrderCatering"));
      ...
      <QueryClientProvider client={queryClient}>
        ...
        <Suspense fallback={<PageLoader />}>
          <Switch>
            ...
            <Route path="/order" component={OrderCatering} />
            ...
            <Route path="/officer/orders" component={OfficerOrders} />
